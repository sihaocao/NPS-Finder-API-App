...
User Directions:
1. Enter the state abbreviation letters (e.g., CA or ca for California) into the field "Enter the STATE for national parks suggestions".
2. Enter a numerical value into the field "Number of national parks you would like to see".
3. Click on the "Let's Find Out!" button to see the list of national parks for your chosen state.